...
def main():
    notebook_path = "EDA_Analysis.ipynb" if os.path.basename(os.getcwd()) == "notebooks" else "notebooks/EDA_Analysis.ipynb"
    ...
    cells.append({
        ...
        "source": [
            ...
            ")\n",
            "fig.add_vrect(x0=\"2023-01-01\", x1=\"2023-12-31\", fillcolor=\"#10b981\", opacity=0.08, line_width=0, \n",
            "              annotation_text=\"2023 Bull Run\", annotation_position=\"top left\")\n",
            "fig.add_vrect(x0=\"2024-05-01\", x1=\"2024-07-31\", fillcolor=\"#ef4444\", opacity=0.08, line_width=0, \n",
            ...
            "plt.axvspan('2023-01-01', '2023-12-31', color='#10b981', alpha=0.08, label='2023 Bull Run')\n",
            "plt.axvspan('2024-05-01', '2024-07-31', color='#ef4444', alpha=0.08, label='2024 Market Correction')\n",
    ...
    cells.append({
        ...
        "source": [
            ...
            "# In x=3 (Year 2025), SBI bar is offset by -0.35\n",
            "plt.annotate(\n",
    ...
    cells.append({
        ...
        "source": [
            ...
            "\n",
            "# Chart 5: Investor Age Group Distribution (Donut Chart)\n",
            ...
            "ax = sns.boxplot(data=df_demog, x='age_group', y='sip_amount', palette='Set2')\n",
            ...
            "ax.set_yticks([500, 1000, 2000, 5000, 10000, 20000, 50000, 100000])\n",
            "ax.get_yaxis().set_major_formatter(ticker.FuncFormatter(lambda y, _: f\"₹{int(y):,}\"))\n",
            "plt.tight_layout()\n",
    ...
    cells.append({
        ...
        "source": [
            ...
            "plt.show()\n",
            "\n",
            "# Chart 9: T30 vs B30 City Tier Donut Chart\n",
    ...
    cells.append({
        ...
        "source": [
            ...
            "plt.xticks(rotation=45)\n",
            "\n",
            "# Find when total folios crossed 20.0 Crore dynamically\n",
            "crossed_20_rows = df_market[df_market['total_folios'] >= 20.0]\n",
            "if not crossed_20_rows.empty:\n",
            "    crossed_20_row = crossed_20_rows.iloc[0]\n",
            "    crossed_20_month = crossed_20_row['month']\n",
            "    crossed_20_val = crossed_20_row['total_folios']\n",
            "else:\n",
            "    crossed_20_month = \"2024-02\"\n",
            "    crossed_20_val = 20.0\n",
            "\n",
            "# Annotate milestones\n",
            ...
            "plt.annotate(f\"20 Cr Crossed ({crossed_20_month})\", xy=(crossed_20_month, crossed_20_val), xytext=(\"2023-01\", 22.0),\n",
    ...
    cells.append({
        ...
        "source": [
            ...
            "    mappings = {\n",
            "        \"SBI Small Cap Fund - Direct Plan - Growth\": \"SBI Small Cap\",\n",
            "        \"Aditya Birla Sun Life Banking & PSU Debt Fund  - DIRECT - IDCW\": \"ABSL Banking & PSU\",\n",
            "        \"Axis ELSS Tax Saver Fund - Direct Plan - Growth Option\": \"Axis ELSS Tax\",\n",
            "        \"Nippon India Large Cap Fund - Direct Plan Growth Plan - Growth Option\": \"Nippon Large Cap\",\n",
            "        \"HDFC Money Market Fund - Growth Option - Direct Plan\": \"HDFC Money Market\",\n",
            "        \"quant Mid Cap Fund - Growth Option - Direct Plan\": \"quant Mid Cap\",\n",
            "        \"HDFC Hybrid Equity Fund - Growth Option - Direct Plan\": \"HDFC Hybrid\",\n",
            "        \"Kotak Multi Asset Omni FOF - Direct Growth - Direct\": \"Kotak Multi Asset FOF\",\n",
            "        \"SBI Bluechip Fund - Direct Plan - Growth\": \"SBI Bluechip\",\n",
            "        \"HDFC Top 100 Fund - Direct Plan - Growth\": \"HDFC Top 100\"\n",
            "    }\n",
            "    if name in mappings:\n",
            "        return mappings[name]\n",
            "    short = name.split(\" - \")[0].split(\"  - \")[0]\n",
            "    for word in [\" Fund\", \" Mutual\", \" Option\", \" Plan\", \" Direct\", \" Growth\", \" Opportunities\", \" Opportunity\"]:\n",
            "        short = short.replace(word, \"\")\n",
            "    if len(short) > 25:\n",
            "        short = short[:22] + \"...\"\n",
            "    return short.strip()\n",
            "df_selected = df_selected.rename(columns=shorten_name)\n",
